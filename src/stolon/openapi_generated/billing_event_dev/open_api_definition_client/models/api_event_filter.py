...
from ..models.api_event_filter_action import ApiEventFilterAction
from ..models.api_event_filter_criteria import ApiEventFilterCriteria
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApiEventFilter")
...
class ApiEventFilter:
    """
    Attributes:
        id (Union[Unset, int]): Id of the event filter
        uuid (Union[Unset, str]): 26-character UUID of the event filter
        criteria (Union[Unset, ApiEventFilterCriteria]):
        action (Union[Unset, ApiEventFilterAction]):
        value (Union[Unset, str]): event filter value
        created_timestamp (Union[Unset, datetime.datetime]): event filter created timestamp Example:
            2020-12-31T23:59:59.123456Z.
        begin_timestamp (Union[Unset, datetime.datetime]): event filter begin filtering timestamp Example:
            2020-12-31T23:59:59.123456Z.
        end_timestamp (Union[Unset, datetime.datetime]): event filter end filtering timestamp Example:
            2020-12-31T23:59:59.123456Z.
    """

    id: Union[Unset, int] = UNSET
    uuid: Union[Unset, str] = UNSET
    criteria: Union[Unset, ApiEventFilterCriteria] = UNSET
    action: Union[Unset, ApiEventFilterAction] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _criteria and not isinstance(_criteria, Unset):
            criteria = ApiEventFilterCriteria(_criteria)
        ...
        if _action and not isinstance(_action, Unset):
            action = ApiEventFilterAction(_action)
        ...
        api_event_filter.additional_properties = d
        return api_event_filter
