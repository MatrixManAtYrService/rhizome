...
class ApiJobResponse:
    """
    Attributes:
        job_id (Union[Unset, str]): Id of the job
        request_uuid (Union[Unset, str]): 26-character UUID of the job request
        return_code (Union[Unset, int]): return code
        reason_code (Union[Unset, int]): reason code
        message (Union[Unset, str]): job response message
    """
