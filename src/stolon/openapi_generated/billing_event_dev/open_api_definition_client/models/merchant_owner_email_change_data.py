...
T = TypeVar("T", bound="MerchantOwnerEmailChangeData")


@_attrs_define
class MerchantOwnerEmailChangeData:
    """
    Attributes:
        merchant (Union[Unset, MerchantData]):
        previous_owner (Union[Unset, str]):
        specific_data (Union[Unset, SpecificData]):
        schema (Union[Unset, Schema]):
    """

    merchant: Union[Unset, "MerchantData"] = UNSET
    previous_owner: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        previous_owner = d.pop("previousOwner", UNSET)
        ...
        merchant_owner_email_change_data = cls(
            merchant=merchant,
        ...
        merchant_owner_email_change_data.additional_properties = d
        return merchant_owner_email_change_data
