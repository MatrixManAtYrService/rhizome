...
from ...models.acknowledge_consumer_failures_response_200 import AcknowledgeConsumerFailuresResponse200
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AcknowledgeConsumerFailuresResponse200.from_dict(response.json())
