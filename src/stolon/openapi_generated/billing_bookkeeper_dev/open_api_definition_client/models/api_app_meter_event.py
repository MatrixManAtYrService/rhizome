...
if TYPE_CHECKING:
    from ..models.api_app_meter_modifier import ApiAppMeterModifier


T = TypeVar("T", bound="ApiAppMeterEvent")


@_attrs_define
class ApiAppMeterEvent:
    """app metered events

    Attributes:
        code (Union[Unset, str]): app metered event code
        ...
        app_metered_uuid (Union[Unset, str]): 13-character UUID assigned to the app metered event type
        ...
        app_meter_mods (Union[Unset, list['ApiAppMeterModifier']]): app metered event modifiers
    """
    ...
    app_meter_mods: Union[Unset, list["ApiAppMeterModifier"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        app_meter_mods: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.app_meter_mods, Unset):
            app_meter_mods = []
            for app_meter_mods_item_data in self.app_meter_mods:
                app_meter_mods_item = app_meter_mods_item_data.to_dict()
                app_meter_mods.append(app_meter_mods_item)
        ...
        if app_meter_mods is not UNSET:
            field_dict["appMeterMods"] = app_meter_mods
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        app_meter_mods = []
        _app_meter_mods = d.pop("appMeterMods", UNSET)
        for app_meter_mods_item_data in _app_meter_mods or []:
            app_meter_mods_item = ApiAppMeterModifier.from_dict(app_meter_mods_item_data)

            app_meter_mods.append(app_meter_mods_item)

        api_app_meter_event = cls(
            code=code,
            ...
            app_meter_mods=app_meter_mods,
        )

        api_app_meter_event.additional_properties = d
        return api_app_meter_event
