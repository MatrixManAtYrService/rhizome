...
T = TypeVar("T", bound="CheckDeveloperEntitiesExistParams")


@_attrs_define
class CheckDeveloperEntitiesExistParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        check_developer_entities_exist_params = cls(
        ...
        check_developer_entities_exist_params.additional_properties = d
        return check_developer_entities_exist_params
