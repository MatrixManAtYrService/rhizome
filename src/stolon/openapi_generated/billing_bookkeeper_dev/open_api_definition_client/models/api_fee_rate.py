...
from ..models.api_fee_rate_apply_type import ApiFeeRateApplyType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApiFeeRate")


@_attrs_define
class ApiFeeRate:
    """All fee rates for the owningBillingEntity that are used to build this abstraction

    Attributes:
        id (Union[Unset, int]): Id of the fee rate
        uuid (Union[Unset, str]): 26-character UUID of the fee rate
        ...
        sourced_from_prototype_fee_rate (Union[Unset, bool]): indicates whether the fee rate was sourced from a
            prototype rate
        ...
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the fee rate was last modified Example:
            2020-12-31T23:59:59.123456Z.
        audit_id (Union[Unset, str]): identifier for the user who created or last modified this fee rate
    """
    ...
    apply_type: Union[Unset, ApiFeeRateApplyType] = UNSET
    per_item_amount: Union[Unset, float] = UNSET
    percentage: Union[Unset, float] = UNSET
    sourced_from_prototype_fee_rate: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        sourced_from_prototype_fee_rate = self.sourced_from_prototype_fee_rate
        ...
        if sourced_from_prototype_fee_rate is not UNSET:
            field_dict["sourcedFromPrototypeFeeRate"] = sourced_from_prototype_fee_rate
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sourced_from_prototype_fee_rate = d.pop("sourcedFromPrototypeFeeRate", UNSET)
        ...
        api_fee_rate = cls(
            ...
            sourced_from_prototype_fee_rate=sourced_from_prototype_fee_rate,
            created_timestamp=created_timestamp,
            modified_timestamp=modified_timestamp,
            audit_id=audit_id,
        )

        api_fee_rate.additional_properties = d
        return api_fee_rate
