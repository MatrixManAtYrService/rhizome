...
T = TypeVar("T", bound="ApiPlanDeviceModifier")


@_attrs_define
class ApiPlanDeviceModifier:
    """device modifiers

    Attributes:
        mod_type (Union[Unset, str]): type of device modifier
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_plan_device_modifier.additional_properties = d
        return api_plan_device_modifier
