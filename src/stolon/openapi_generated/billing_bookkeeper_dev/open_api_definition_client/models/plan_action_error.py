...
T = TypeVar("T", bound="PlanActionError")


@_attrs_define
class PlanActionError:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        plan_action_uuid (Union[Unset, str]):
    ...
    plan_action_uuid: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        plan_action_uuid = self.plan_action_uuid
        ...
        if plan_action_uuid is not UNSET:
            field_dict["planActionUuid"] = plan_action_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        plan_action_uuid = d.pop("planActionUuid", UNSET)

        action_uuid = d.pop("actionUuid", UNSET)

        plan_action_error = cls(
            id=id,
            uuid=uuid,
            ...
            plan_action_uuid=plan_action_uuid,
            action_uuid=action_uuid,
        )

        plan_action_error.additional_properties = d
        return plan_action_error
