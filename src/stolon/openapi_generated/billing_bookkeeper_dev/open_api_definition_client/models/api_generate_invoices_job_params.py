...
T = TypeVar("T", bound="ApiGenerateInvoicesJobParams")


@_attrs_define
class ApiGenerateInvoicesJobParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_generate_invoices_job_params = cls(
        ...
        api_generate_invoices_job_params.additional_properties = d
        return api_generate_invoices_job_params
