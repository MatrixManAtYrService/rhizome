...
T = TypeVar("T", bound="ApiAdjustActionFeeCode")


@_attrs_define
class ApiAdjustActionFeeCode:
    """
    Attributes:
        id (Union[Unset, int]): Id of the adjustment-action-to-fee-code mapping
        uuid (Union[Unset, str]): 26-character UUID of the adjustment-action-to-fee-code mapping
        ...
        effective_date (Union[Unset, datetime.date]): effective date for the adjustment-action-to-fee-code mapping
        fee_category (Union[Unset, str]): fee category mapped to by the adjustment action
        fee_code (Union[Unset, str]): fee code mapped to by the adjustment action
        deleted_date (Union[Unset, datetime.date]): date the adjustment-action-to-fee-code mapping is no longer
            effective, or was logically deleted
        created_timestamp (Union[Unset, datetime.datetime]): date and time when the adjustment-action-to-fee-code
            mapping was created Example: 2020-12-31T23:59:59.123456Z.
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the adjustment-action-to-fee-code
            mapping was last modified Example: 2020-12-31T23:59:59.123456Z.
        audit_id (Union[Unset, str]): identifier for the user who created or last modified this adjustment-action-to-
            fee-code mapping
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_adjust_action_fee_code = cls(
            id=id,
            uuid=uuid,
        ...
        api_adjust_action_fee_code.additional_properties = d
        return api_adjust_action_fee_code
