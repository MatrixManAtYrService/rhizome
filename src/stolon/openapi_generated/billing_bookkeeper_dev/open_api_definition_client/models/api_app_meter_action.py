...
T = TypeVar("T", bound="ApiAppMeterAction")


@_attrs_define
class ApiAppMeterAction:
    """
    Attributes:
        id (Union[Unset, int]): Id of the app meter action
        uuid (Union[Unset, str]): 26-character UUID of the app meter action
        billing_entity_uuid (Union[Unset, str]): 26-character UUID of the billing entity this app meter action belongs
            to
        ...
        app_meter_action_type (Union[Unset, str]): defined app meter action type value
        fee_category (Union[Unset, str]): defined fee category value
        fee_code (Union[Unset, str]): defined fee code value
        action_date_time (Union[Unset, datetime.datetime]): date and time that the app meter action occurred Example:
        ...
        num_units (Union[Unset, int]): the number of billable units for the app meter action
        units_in_period (Union[Unset, int]): the number of billable units in the billing entity billing period
        basis_amount (Union[Unset, float]): the basis amount for the app meter action
        basis_currency (Union[Unset, str]): 3-letter currency code Example: USD.
        reference (Union[Unset, str]): freeform comment or reference identifier for this app meter action
        app_meter_action_fee_code_uuid (Union[Unset, str]): 26-character UUID of the app-meter-action-to-fee-code
            mapping used to create this action
        fee_uuid (Union[Unset, str]): 26-character UUID of the fee CTD or fee summary that this app meter action was
            applied towards
        event_uuid (Union[Unset, str]): 26-character UUID of the billing event that triggered this app meter action
        request_uuid (Union[Unset, str]): 26-character UUID of the billing request that posted this app meter action to
            the current-to-date totals
        posting_date (Union[Unset, datetime.date]): posting date
        created_timestamp (Union[Unset, datetime.datetime]): date and time when the app meter action was created
            Example: 2020-12-31T23:59:59.123456Z.
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the app meter action was last modified
            Example: 2020-12-31T23:59:59.123456Z.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_app_meter_action.additional_properties = d
        return api_app_meter_action
