...
T = TypeVar("T", bound="AppMeterActionError")


@_attrs_define
class AppMeterActionError:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        app_meter_action_uuid (Union[Unset, str]):
    ...
    app_meter_action_uuid: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        app_meter_action_uuid = self.app_meter_action_uuid
        ...
        if app_meter_action_uuid is not UNSET:
            field_dict["appMeterActionUuid"] = app_meter_action_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        app_meter_action_uuid = d.pop("appMeterActionUuid", UNSET)

        action_uuid = d.pop("actionUuid", UNSET)

        app_meter_action_error = cls(
            id=id,
            uuid=uuid,
            ...
            app_meter_action_uuid=app_meter_action_uuid,
            action_uuid=action_uuid,
        )

        app_meter_action_error.additional_properties = d
        return app_meter_action_error
