...
T = TypeVar("T", bound="ApiCellularBillingMethod")


@_attrs_define
class ApiCellularBillingMethod:
    """
    Attributes:
        cellular_billing_method (Union[Unset, str]): cellular billing method value
        valid_hierarchy_types (Union[Unset, list[str]]): billing hierarchy types where the cellular billing method is
            valid
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_cellular_billing_method = cls(
            cellular_billing_method=cellular_billing_method,
            valid_hierarchy_types=valid_hierarchy_types,
        )

        api_cellular_billing_method.additional_properties = d
        return api_cellular_billing_method
