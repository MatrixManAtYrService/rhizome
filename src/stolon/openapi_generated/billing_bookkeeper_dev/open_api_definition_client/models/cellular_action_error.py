...
T = TypeVar("T", bound="CellularActionError")


@_attrs_define
class CellularActionError:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        cellular_action_uuid (Union[Unset, str]):
    ...
    cellular_action_uuid: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        cellular_action_uuid = self.cellular_action_uuid
        ...
        if cellular_action_uuid is not UNSET:
            field_dict["cellularActionUuid"] = cellular_action_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cellular_action_uuid = d.pop("cellularActionUuid", UNSET)

        action_uuid = d.pop("actionUuid", UNSET)

        cellular_action_error = cls(
            id=id,
            uuid=uuid,
            ...
            cellular_action_uuid=cellular_action_uuid,
            action_uuid=action_uuid,
        )

        cellular_action_error.additional_properties = d
        return cellular_action_error
