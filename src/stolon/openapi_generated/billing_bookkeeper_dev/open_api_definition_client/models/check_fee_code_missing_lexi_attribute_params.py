...
T = TypeVar("T", bound="CheckFeeCodeMissingLexiAttributeParams")


@_attrs_define
class CheckFeeCodeMissingLexiAttributeParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        check_fee_code_missing_lexi_attribute_params = cls(
        ...
        check_fee_code_missing_lexi_attribute_params.additional_properties = d
        return check_fee_code_missing_lexi_attribute_params
