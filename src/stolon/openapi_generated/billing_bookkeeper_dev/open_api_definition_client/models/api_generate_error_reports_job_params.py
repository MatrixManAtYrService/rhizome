...
T = TypeVar("T", bound="ApiGenerateErrorReportsJobParams")


@_attrs_define
class ApiGenerateErrorReportsJobParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_generate_error_reports_job_params = cls(
            reference_uuid=reference_uuid,
            hierarchy_type=hierarchy_type,
            environment=environment,
        )

        api_generate_error_reports_job_params.additional_properties = d
        return api_generate_error_reports_job_params
