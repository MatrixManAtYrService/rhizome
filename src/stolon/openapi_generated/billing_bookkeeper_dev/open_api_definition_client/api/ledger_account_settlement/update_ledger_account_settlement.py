...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/v1/ledgeracctsettlement/{uuid}",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = ApiLedgerAccountSettlement.from_dict(response.json())

        return response_400

    if response.status_code == 404:
        response_404 = ApiLedgerAccountSettlement.from_dict(response.json())
