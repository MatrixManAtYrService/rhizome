...
class Acceptance:
    ...
    Attributes:
        ...
        signer_signature (Union[Unset, list[str]]):
    ...
    signer_signature: Union[Unset, list[str]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        signer_signature: Union[Unset, list[str]] = UNSET
        if not isinstance(self.signer_signature, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        agreement_id = UUID(d.pop("agreementId"))
        ...
        signer_signature = cast(list[str], d.pop("signerSignature", UNSET))
