...
T = TypeVar("T", bound="AcceptanceQueryV2")


@_attrs_define
class AcceptanceQueryV2:
    """
    Attributes:
        ...
        type_in (Union[Unset, list[str]]):
        include_only_latest (Union[Unset, bool]):
    ...
    type_in: Union[Unset, list[str]] = UNSET
    include_only_latest: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        type_in: Union[Unset, list[str]] = UNSET
        if not isinstance(self.type_in, Unset):
            type_in = self.type_in

        include_only_latest = self.include_only_latest
        ...
        if type_in is not UNSET:
            field_dict["typeIn"] = type_in
        if include_only_latest is not UNSET:
            field_dict["includeOnlyLatest"] = include_only_latest
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_in = cast(list[str], d.pop("typeIn", UNSET))

        include_only_latest = d.pop("includeOnlyLatest", UNSET)

        action = d.pop("action", UNSET)

        acceptance_query_v2 = cls(
            ...
            type_in=type_in,
            include_only_latest=include_only_latest,
            action=action,
        )

        acceptance_query_v2.additional_properties = d
        return acceptance_query_v2
