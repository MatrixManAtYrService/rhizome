...
class Agreements:
    """
    Attributes:
        elements (Union[Unset, list['Agreement']]):
    """

    elements: Union[Unset, list["Agreement"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for elements_item_data in _elements or []:
            elements_item = Agreement.from_dict(elements_item_data)
        ...
        agreements.additional_properties = d
        return agreements
