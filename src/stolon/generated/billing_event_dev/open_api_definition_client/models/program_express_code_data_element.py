...
from ..models.program_express_code_data_element_action import ProgramExpressCodeDataElementAction
...
T = TypeVar("T", bound="ProgramExpressCodeDataElement")


@_attrs_define
class ProgramExpressCodeDataElement:
    """
    Attributes:
        action (Union[Unset, ProgramExpressCodeDataElementAction]):
    ...
    action: Union[Unset, ProgramExpressCodeDataElementAction] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_action, Unset):
            ...
            action = ProgramExpressCodeDataElementAction(_action)
        ...
        program_express_code_data_element = cls(
            action=action,
        ...
        program_express_code_data_element.additional_properties = d
        return program_express_code_data_element
