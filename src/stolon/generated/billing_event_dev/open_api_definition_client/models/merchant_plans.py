...
T = TypeVar("T", bound="MerchantPlans")
...
class MerchantPlans:
    """
    Attributes:
        elements (Union[Unset, list['MerchantPlan']]):
    """

    elements: Union[Unset, list["MerchantPlan"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for elements_item_data in _elements or []:
            elements_item = MerchantPlan.from_dict(elements_item_data)
        ...
        merchant_plans.additional_properties = d
