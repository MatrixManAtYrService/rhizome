...
class Modules:
    """
    Attributes:
        elements (Union[Unset, list['Module']]):
    """

    elements: Union[Unset, list["Module"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for elements_item_data in _elements or []:
            elements_item = Module.from_dict(elements_item_data)
        ...
        modules.additional_properties = d
        return modules
