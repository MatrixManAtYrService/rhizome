...
if TYPE_CHECKING:
    from ..models.specific_data_class_loader_parent_defined_packages_item_annotations_item import (
        SpecificDataClassLoaderParentDefinedPackagesItemAnnotationsItem,
    )
    from ..models.specific_data_class_loader_parent_defined_packages_item_declared_annotations_item import (
        SpecificDataClassLoaderParentDefinedPackagesItemDeclaredAnnotationsItem,
    )


T = TypeVar("T", bound="SpecificDataClassLoaderParentDefinedPackagesItem")


@_attrs_define
class SpecificDataClassLoaderParentDefinedPackagesItem:
    """
    Attributes:
        name (Union[Unset, str]):
        annotations (Union[Unset, list['SpecificDataClassLoaderParentDefinedPackagesItemAnnotationsItem']]):
        declared_annotations (Union[Unset,
            list['SpecificDataClassLoaderParentDefinedPackagesItemDeclaredAnnotationsItem']]):
    ...
    annotations: Union[Unset, list["SpecificDataClassLoaderParentDefinedPackagesItemAnnotationsItem"]] = UNSET
    declared_annotations: Union[
        Unset, list["SpecificDataClassLoaderParentDefinedPackagesItemDeclaredAnnotationsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for annotations_item_data in _annotations or []:
            annotations_item = SpecificDataClassLoaderParentDefinedPackagesItemAnnotationsItem.from_dict(
        ...
        for declared_annotations_item_data in _declared_annotations or []:
            declared_annotations_item = (
                SpecificDataClassLoaderParentDefinedPackagesItemDeclaredAnnotationsItem.from_dict(
        ...
        specific_data_class_loader_parent_defined_packages_item = cls(
            name=name,
        ...
        specific_data_class_loader_parent_defined_packages_item.additional_properties = d
        return specific_data_class_loader_parent_defined_packages_item
