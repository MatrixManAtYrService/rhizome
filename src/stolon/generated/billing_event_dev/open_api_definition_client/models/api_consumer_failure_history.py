...
from ..models.api_consumer_failure_history_consumer_source import ApiConsumerFailureHistoryConsumerSource
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApiConsumerFailureHistory")


@_attrs_define
class ApiConsumerFailureHistory:
    """
    Attributes:
        ...
        consumer_source (Union[Unset, ApiConsumerFailureHistoryConsumerSource]):
    ...
    consumer_source: Union[Unset, ApiConsumerFailureHistoryConsumerSource] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_consumer_source, Unset):
            ...
            consumer_source = ApiConsumerFailureHistoryConsumerSource(_consumer_source)
        ...
        api_consumer_failure_history = cls(
            id=id,
            uuid=uuid,
        ...
        api_consumer_failure_history.additional_properties = d
        return api_consumer_failure_history
