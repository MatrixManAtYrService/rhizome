...
if TYPE_CHECKING:
    from ..models.specific_data_class_loader_parent_unnamed_module_annotations_item import (
        SpecificDataClassLoaderParentUnnamedModuleAnnotationsItem,
    )
    from ..models.specific_data_class_loader_parent_unnamed_module_declared_annotations_item import (
        SpecificDataClassLoaderParentUnnamedModuleDeclaredAnnotationsItem,
    )
    from ..models.specific_data_class_loader_parent_unnamed_module_descriptor import (
        SpecificDataClassLoaderParentUnnamedModuleDescriptor,
    )
    from ..models.specific_data_class_loader_parent_unnamed_module_layer import (
        SpecificDataClassLoaderParentUnnamedModuleLayer,
    )


T = TypeVar("T", bound="SpecificDataClassLoaderParentUnnamedModule")


@_attrs_define
class SpecificDataClassLoaderParentUnnamedModule:
    """
    Attributes:
        name (Union[Unset, str]):
        descriptor (Union[Unset, SpecificDataClassLoaderParentUnnamedModuleDescriptor]):
        named (Union[Unset, bool]):
        annotations (Union[Unset, list['SpecificDataClassLoaderParentUnnamedModuleAnnotationsItem']]):
        declared_annotations (Union[Unset, list['SpecificDataClassLoaderParentUnnamedModuleDeclaredAnnotationsItem']]):
        packages (Union[Unset, list[str]]):
        layer (Union[Unset, SpecificDataClassLoaderParentUnnamedModuleLayer]):
    """

    name: Union[Unset, str] = UNSET
    descriptor: Union[Unset, "SpecificDataClassLoaderParentUnnamedModuleDescriptor"] = UNSET
    named: Union[Unset, bool] = UNSET
    annotations: Union[Unset, list["SpecificDataClassLoaderParentUnnamedModuleAnnotationsItem"]] = UNSET
    declared_annotations: Union[Unset, list["SpecificDataClassLoaderParentUnnamedModuleDeclaredAnnotationsItem"]] = (
        UNSET
    )
    packages: Union[Unset, list[str]] = UNSET
    layer: Union[Unset, "SpecificDataClassLoaderParentUnnamedModuleLayer"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for annotations_item_data in _annotations or []:
            annotations_item = SpecificDataClassLoaderParentUnnamedModuleAnnotationsItem.from_dict(
        ...
        for declared_annotations_item_data in _declared_annotations or []:
            declared_annotations_item = SpecificDataClassLoaderParentUnnamedModuleDeclaredAnnotationsItem.from_dict(
        ...
        specific_data_class_loader_parent_unnamed_module.additional_properties = d
        return specific_data_class_loader_parent_unnamed_module
