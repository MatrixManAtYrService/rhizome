...
from ..models.api_producer_failure_event_source import ApiProducerFailureEventSource
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApiProducerFailure")


@_attrs_define
class ApiProducerFailure:
    """
    Attributes:
    ...
    event_source: Union[Unset, ApiProducerFailureEventSource] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_producer_failure.additional_properties = d
        return api_producer_failure
