...
from ...models.api_merchant_acceptance import ApiMerchantAcceptance
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ApiMerchantAcceptance.from_dict(response.json())
    ...
    if response.status_code == 400:
        ...
        for response_400_item_data in _response_400:
            response_400_item = ApiMerchantAcceptance.from_dict(response_400_item_data)
