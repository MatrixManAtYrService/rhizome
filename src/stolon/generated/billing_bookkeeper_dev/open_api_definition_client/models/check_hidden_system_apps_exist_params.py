...
T = TypeVar("T", bound="CheckHiddenSystemAppsExistParams")


@_attrs_define
class CheckHiddenSystemAppsExistParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        check_hidden_system_apps_exist_params = cls(
        ...
        check_hidden_system_apps_exist_params.additional_properties = d
        return check_hidden_system_apps_exist_params
