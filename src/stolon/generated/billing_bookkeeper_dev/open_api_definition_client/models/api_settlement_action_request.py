...
T = TypeVar("T", bound="ApiSettlementActionRequest")


@_attrs_define
class ApiSettlementActionRequest:
    """
    Attributes:
    ...
    tlement_uuid: Union[Unset, "ApiSettlementActionRequest"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_settlement_action_request = cls(
        ...
        api_settlement_action_request.additional_properties = d
        return api_settlement_action_request
