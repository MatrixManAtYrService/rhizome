...
T = TypeVar("T", bound="ApiPartnerConfig")


@_attrs_define
class ApiPartnerConfig:
    """
    Attributes:
        tlement_method (Union[Unset, ApiPartnerConfig]):
        id (Union[Unset, int]): Id of the partner config instance
        uuid (Union[Unset, str]): 26-character UUID of the partner config instance
        billing_entity_uuid (Union[Unset, str]): UUID of the billing entity associated with this partner config
        effective_date (Union[Unset, datetime.date]): effective date for the partner config values
        hierarchy_type (Union[Unset, str]): billing hierarchy type that the partner configuration applies to
        revenue_share_group (Union[Unset, str]): group that the partner belongs to for revenue share splits
        ...
        seasonal_rule_set_uuid (Union[Unset, str]): UUID of the seasonal monetary rule set associated with this partner
            config
        created_timestamp (Union[Unset, datetime.datetime]): date and time when the partner config was created Example:
            2020-12-31T23:59:59.123456Z.
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the partner config was last modified
            Example: 2020-12-31T23:59:59.123456Z.
        audit_id (Union[Unset, str]): identifier for the user who created or last modified this partner config
    """

    tlement_method: Union[Unset, "ApiPartnerConfig"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_partner_config.additional_properties = d
        return api_partner_config
