...
T = TypeVar("T", bound="ApiRevenueModifier")


@_attrs_define
class ApiRevenueModifier:
    """revenue event modifiers

    Attributes:
        mod_type (Union[Unset, str]): type of revenue modifier
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_revenue_modifier.additional_properties = d
        return api_revenue_modifier
