...
T = TypeVar("T", bound="ApiAppSubModifier")


@_attrs_define
class ApiAppSubModifier:
    """app subscription event modifiers

    Attributes:
        mod_type (Union[Unset, str]): type of app subscription modifier
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_app_sub_modifier.additional_properties = d
        return api_app_sub_modifier
