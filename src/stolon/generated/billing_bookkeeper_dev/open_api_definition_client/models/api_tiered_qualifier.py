...
T = TypeVar("T", bound="ApiTieredQualifier")


@_attrs_define
class ApiTieredQualifier:
    """
    Attributes:
        id (Union[Unset, int]): ID of the tiered rule qualifier
        uuid (Union[Unset, str]): 26-character UUID of the tiered rule qualifier
        tiered_rule_uuid (Union[Unset, str]): 26-character UUID of the tiered rule that this qualifier applies to
        fee_category (Union[Unset, str]): the fee category that qualifies for the tiered rule
        fee_code (Union[Unset, str]): the fee code that qualifies for the tiered rule
        ...
        negate_fee_summary (Union[Unset, bool]): indicates whether to negate the unit and amount totals from qualified
            fee summaries
        created_timestamp (Union[Unset, datetime.datetime]): date and time when the tiered rule qualifier was created
            Example: 2020-12-31T23:59:59.123456Z.
        audit_id (Union[Unset, str]): identifier for the user who created or last modified this tiered rule qualifier
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_tiered_qualifier.additional_properties = d
        return api_tiered_qualifier
