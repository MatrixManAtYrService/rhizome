...
T = TypeVar("T", bound="ApiAdjustAction")


@_attrs_define
class ApiAdjustAction:
    """
    Attributes:
        tlement_uuid (Union[Unset, ApiAdjustAction]):
        id (Union[Unset, int]): Id of the adjustment action
        uuid (Union[Unset, str]): 26-character UUID of the adjustment action
        billing_entity_uuid (Union[Unset, str]): 26-character UUID of the billing entity this adjustment action belongs
            to
        billing_entity_name (Union[Unset, str]): name of the billing entity
        entity_uuid (Union[Unset, str]): 13-character UUID of the COS entity that this billing entity represents
        settlement_uuid (Union[Unset, str]): 26-character UUID of the settlement request that the adjustment action
            applies to
        adjust_reason (Union[Unset, str]): reason for the adjustment action
        developer_uuid (Union[Unset, str]): 13-character UUID of the developer that the action applies to; only applies
            to app-related adjustments
        developer_app_uuid (Union[Unset, str]): 13-character UUID of the developer app that the action applies to; only
        ...
        action_date_time (Union[Unset, datetime.datetime]): date and time that the adjustment action occurred Example:
            2020-12-31T23:59:59.123456Z.
        num_units (Union[Unset, int]): the number of billable units for the adjustment action
        units_in_period (Union[Unset, int]): the number of billable units in the billing entity billing period
        basis_amount (Union[Unset, float]): the basis amount for the adjustment action
        ...
        adjust_action_fee_code_uuid (Union[Unset, str]): 26-character UUID of the adjustment-action-to-fee-code mapping
            used to create this action
        fee_uuid (Union[Unset, str]): 26-character UUID of the fee CTD or fee summary that this adjustment action was
            applied towards
        event_uuid (Union[Unset, str]): 26-character UUID of the billing event that triggered this adjustment action, if
            done via a billing event
        request_uuid (Union[Unset, str]): 26-character UUID of the billing request that posted this adjustment action to
            the current-to-date totals, if done via batch posting
        posting_date (Union[Unset, datetime.date]): posting date
        created_timestamp (Union[Unset, datetime.datetime]): date and time when the adjustment action was created
            Example: 2020-12-31T23:59:59.123456Z.
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the adjustment action was last modified
            Example: 2020-12-31T23:59:59.123456Z.
    """

    tlement_uuid: Union[Unset, "ApiAdjustAction"] = UNSET
    ...
    adjust_action_fee_code_uuid: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        adjust_action_fee_code_uuid = self.adjust_action_fee_code_uuid
        ...
        if adjust_action_fee_code_uuid is not UNSET:
            field_dict["adjustActionFeeCodeUuid"] = adjust_action_fee_code_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_tlement_uuid, Unset):
            ...
            tlement_uuid = ApiAdjustAction.from_dict(_tlement_uuid)
        ...
        adjust_action_fee_code_uuid = d.pop("adjustActionFeeCodeUuid", UNSET)
        ...
        api_adjust_action = cls(
            ...
            reference=reference,
            adjust_action_fee_code_uuid=adjust_action_fee_code_uuid,
            fee_uuid=fee_uuid,
        ...
        api_adjust_action.additional_properties = d
        return api_adjust_action
