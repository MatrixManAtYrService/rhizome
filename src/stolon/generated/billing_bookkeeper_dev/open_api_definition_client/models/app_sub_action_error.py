...
T = TypeVar("T", bound="AppSubActionError")


@_attrs_define
class AppSubActionError:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        app_sub_action_uuid (Union[Unset, str]):
    ...
    app_sub_action_uuid: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        app_sub_action_uuid = self.app_sub_action_uuid
        ...
        if app_sub_action_uuid is not UNSET:
            field_dict["appSubActionUuid"] = app_sub_action_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        app_sub_action_uuid = d.pop("appSubActionUuid", UNSET)

        action_uuid = d.pop("actionUuid", UNSET)

        app_sub_action_error = cls(
            id=id,
            uuid=uuid,
            ...
            app_sub_action_uuid=app_sub_action_uuid,
            action_uuid=action_uuid,
        )

        app_sub_action_error.additional_properties = d
        return app_sub_action_error
