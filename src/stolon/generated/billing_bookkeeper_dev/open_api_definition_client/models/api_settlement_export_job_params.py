...
T = TypeVar("T", bound="ApiSettlementExportJobParams")


@_attrs_define
class ApiSettlementExportJobParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_settlement_export_job_params = cls(
        ...
        api_settlement_export_job_params.additional_properties = d
        return api_settlement_export_job_params
