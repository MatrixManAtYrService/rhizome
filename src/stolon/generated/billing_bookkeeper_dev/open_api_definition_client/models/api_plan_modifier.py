...
T = TypeVar("T", bound="ApiPlanModifier")


@_attrs_define
class ApiPlanModifier:
    """plan event modifiers

    Attributes:
        mod_type (Union[Unset, str]): type of plan modifier
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_plan_modifier.additional_properties = d
        return api_plan_modifier
