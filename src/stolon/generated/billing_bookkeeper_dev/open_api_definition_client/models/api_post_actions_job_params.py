...
T = TypeVar("T", bound="ApiPostActionsJobParams")


@_attrs_define
class ApiPostActionsJobParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_post_actions_job_params = cls(
        ...
        api_post_actions_job_params.additional_properties = d
        return api_post_actions_job_params
