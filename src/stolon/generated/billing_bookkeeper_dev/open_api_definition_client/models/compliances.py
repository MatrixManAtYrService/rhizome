...
class Compliances:
    """
    Attributes:
        elements (Union[Unset, list['Compliance']]):
    """

    elements: Union[Unset, list["Compliance"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for elements_item_data in _elements or []:
            elements_item = Compliance.from_dict(elements_item_data)
        ...
        compliances.additional_properties = d
        return compliances
