...
T = TypeVar("T", bound="AppMeterAction")


@_attrs_define
class AppMeterAction:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        app_meter_action_fee_code_uuid (Union[Unset, str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        app_meter_action.additional_properties = d
        return app_meter_action
