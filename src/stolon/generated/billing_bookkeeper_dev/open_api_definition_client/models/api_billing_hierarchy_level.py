...
from ..models.api_billing_hierarchy_level_entity_type import ApiBillingHierarchyLevelEntityType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApiBillingHierarchyLevel")


@_attrs_define
class ApiBillingHierarchyLevel:
    """
    Attributes:
        ...
        entity_type (Union[Unset, ApiBillingHierarchyLevelEntityType]):
    ...
    entity_type: Union[Unset, ApiBillingHierarchyLevelEntityType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_entity_type, Unset):
            ...
            entity_type = ApiBillingHierarchyLevelEntityType(_entity_type)
        ...
        api_billing_hierarchy_level = cls(
            id=id,
            uuid=uuid,
        ...
        api_billing_hierarchy_level.additional_properties = d
        return api_billing_hierarchy_level
