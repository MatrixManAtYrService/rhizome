...
T = TypeVar("T", bound="AutoAdjustAdvice")


@_attrs_define
class AutoAdjustAdvice:
    """
    Attributes:
        id (Union[Unset, int]):
        uuid (Union[Unset, str]):
        billing_entity_uuid (Union[Unset, str]):
        auto_adjust_rule_uuid (Union[Unset, str]):
        start_date (Union[Unset, datetime.date]):
        deleted_date (Union[Unset, datetime.date]):
        total_periods (Union[Unset, int]):
        evaluated_periods (Union[Unset, int]):
        applied_periods (Union[Unset, int]):
        max_units (Union[Unset, float]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auto_adjust_advice.additional_properties = d
        return auto_adjust_advice
