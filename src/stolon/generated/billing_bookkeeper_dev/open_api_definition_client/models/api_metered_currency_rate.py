...
T = TypeVar("T", bound="ApiMeteredCurrencyRate")


@_attrs_define
class ApiMeteredCurrencyRate:
    """rates for the metered event broken down by currency
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_metered_currency_rate = cls(
            currency=currency,
            cost=cost,
            percentage=percentage,
        )

        api_metered_currency_rate.additional_properties = d
        return api_metered_currency_rate
