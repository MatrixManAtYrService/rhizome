...
T = TypeVar("T", bound="ApiLedgerAccount")


@_attrs_define
class ApiLedgerAccount:
    """
    Attributes:
        id (Union[Unset, int]): Id of the ledger account
        uuid (Union[Unset, str]): 26-character UUID of the ledger account
        billing_entity_uuid (Union[Unset, str]): 26-character UUID of the billing entity this ledger account belongs to
        ledger_account_key (Union[Unset, str]): the ledger account key for this ledger account
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_ledger_account.additional_properties = d
        return api_ledger_account
