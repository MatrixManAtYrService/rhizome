...
if TYPE_CHECKING:
    from ..models.metered import Metered


T = TypeVar("T", bound="Metereds")
...
class Metereds:
    """
    Attributes:
        elements (Union[Unset, list['Metered']]):
    """

    elements: Union[Unset, list["Metered"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for elements_item_data in _elements or []:
            elements_item = Metered.from_dict(elements_item_data)
        ...
        metereds.additional_properties = d
        return metereds
