...
T = TypeVar("T", bound="EbbMerchantPlanHistory")


@_attrs_define
class EbbMerchantPlanHistory:
    """
    Attributes:
        old_plan (Union[Unset, EbbMerchantPlan]):
        new_plan (Union[Unset, EbbMerchantPlan]):
        changed_time (Union[Unset, int]):
    """

    old_plan: Union[Unset, "EbbMerchantPlan"] = UNSET
    new_plan: Union[Unset, "EbbMerchantPlan"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_old_plan, Unset):
            ...
            old_plan = EbbMerchantPlan.from_dict(_old_plan)
        ...
        if isinstance(_new_plan, Unset):
            ...
            new_plan = EbbMerchantPlan.from_dict(_new_plan)

        changed_time = d.pop("changedTime", UNSET)

        ebb_merchant_plan_history = cls(
            old_plan=old_plan,
            new_plan=new_plan,
            changed_time=changed_time,
        )

        ebb_merchant_plan_history.additional_properties = d
        return ebb_merchant_plan_history
