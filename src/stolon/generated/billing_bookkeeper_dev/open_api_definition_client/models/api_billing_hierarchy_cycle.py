...
from ..models.api_billing_hierarchy_cycle_frequency import ApiBillingHierarchyCycleFrequency
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApiBillingHierarchyCycle")


@_attrs_define
class ApiBillingHierarchyCycle:
    """
    Attributes:
        tlement_method (Union[Unset, ApiBillingHierarchyCycle]):
        id (Union[Unset, int]): Id of the billing hierarchy cycle entry
        uuid (Union[Unset, str]): 26-character UUID of the billing hierarchy cycle entry
        processing_group_uuid (Union[Unset, str]): UUID of the processing group that the billing hierarchy cycle entry
            belongs to on the cycle date
        billing_hierarchy_uuid (Union[Unset, str]): UUID of the billing hierarchy node associated with the processing
            group, hierarchy type, and cycle date
        cycle_date (Union[Unset, datetime.date]): date that this billing hierarchy cycle entry is for
        close_date (Union[Unset, datetime.date]): date that this billing hierarchy cycle entry might have been closed on
        effective_close_date (Union[Unset, datetime.date]): date that this billing hierarchy cycle entry closure is
            effective on
        billing_entity_uuid (Union[Unset, str]): UUID of the merchant, reseller, or developer billing entity associated
            with this hierarchy cycle entry
        entity_uuid (Union[Unset, str]): 13-character UUID of the merchant, reseller, or developer entity associated
            with this hierarchy cycle entry
        billing_entity_name (Union[Unset, str]): name of the merchant, reseller, or developer billing entity associated
            with this hierarchy cycle entry
        schedule_parent_billing_entity_uuid (Union[Unset, str]): UUID of the parent billing entity within the schedule
            hierarchy for the merchant, reseller, or developer billing entity associated with this hierarchy cycle entry
        fee_rate_parent_billing_entity_uuid (Union[Unset, str]): UUID of the parent billing entity within the fee rate
            hierarchy for the merchant, reseller, or developer billing entity associated with this hierarchy cycle entry
        frequency (Union[Unset, ApiBillingHierarchyCycleFrequency]):
        billing_day (Union[Unset, int]): billing day within the billing period
        next_billing_date (Union[Unset, datetime.date]): next billing date based on current billing frequency
        last_billing_date (Union[Unset, datetime.date]): date the billing entity was last billed
        arrears_billing_date (Union[Unset, datetime.date]): date the for the start of the arrears billing period
        ...
        units_in_arrears_period (Union[Unset, int]): number of units in the arrears billing period
        default_currency (Union[Unset, str]): 3-letter currency code of the default currency for the billing entity
            Example: USD.
        post_method (Union[Unset, str]): method used to post actions
        plan_billing_method (Union[Unset, str]): method used to for plan SaaS billing
        ...
        seasonal_rule_set_uuid (Union[Unset, str]): UUID of the monetary rule set for seasonal merchant processing
        created_timestamp (Union[Unset, datetime.datetime]): date and time when the billing hierarchy cycle entry was
            created Example: 2020-12-31T23:59:59.123456Z.
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the billing hierarchy cycle entry was
            last modified Example: 2020-12-31T23:59:59.123456Z.
    """

    tlement_method: Union[Unset, "ApiBillingHierarchyCycle"] = UNSET
    ...
    frequency: Union[Unset, ApiBillingHierarchyCycleFrequency] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_billing_hierarchy_cycle.additional_properties = d
        return api_billing_hierarchy_cycle
