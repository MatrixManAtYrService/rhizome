...
from ..models.api_fee_summary_extended_apply_type import ApiFeeSummaryExtendedApplyType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApiFeeSummaryExtended")


@_attrs_define
class ApiFeeSummaryExtended:
    """
    Attributes:
        ...
        apply_type (Union[Unset, ApiFeeSummaryExtendedApplyType]):
    ...
    apply_type: Union[Unset, ApiFeeSummaryExtendedApplyType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_apply_type, Unset):
            ...
            apply_type = ApiFeeSummaryExtendedApplyType(_apply_type)
        ...
        api_fee_summary_extended.additional_properties = d
        return api_fee_summary_extended
