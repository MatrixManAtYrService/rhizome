...
from ..models.api_ledger_account_transition_credit_billing_entity_uuid_source import (
    ApiLedgerAccountTransitionCreditBillingEntityUuidSource,
)
from ..models.api_ledger_account_transition_debit_billing_entity_uuid_source import (
    ApiLedgerAccountTransitionDebitBillingEntityUuidSource,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ApiLedgerAccountTransition")


@_attrs_define
class ApiLedgerAccountTransition:
    """
    Attributes:
        id (Union[Unset, int]): Id of the ledger-account-transition mapping
        uuid (Union[Unset, str]): 26-character UUID of the ledger-account-transition mapping
        action (Union[Unset, str]): the action that maps to the ledger account transition
        effective_date (Union[Unset, datetime.date]): effective date for the ledger-account-transition mapping
        lookup_ledger_account_key (Union[Unset, str]): the ledger account key used to lookup the transition flow
        credit_ledger_account_key (Union[Unset, str]): the credit ledger account key that the action maps to
        credit_billing_entity_uuid_source (Union[Unset, ApiLedgerAccountTransitionCreditBillingEntityUuidSource]):
        debit_ledger_account_key (Union[Unset, str]): the debit ledger account key that the action maps to
        debit_billing_entity_uuid_source (Union[Unset, ApiLedgerAccountTransitionDebitBillingEntityUuidSource]):
        deleted_date (Union[Unset, datetime.date]): date the ledger-account-transition mapping is no longer effective,
        ...
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the ledger account transition was last
    ...
    credit_billing_entity_uuid_source: Union[Unset, ApiLedgerAccountTransitionCreditBillingEntityUuidSource] = UNSET
    debit_ledger_account_key: Union[Unset, str] = UNSET
    debit_billing_entity_uuid_source: Union[Unset, ApiLedgerAccountTransitionDebitBillingEntityUuidSource] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_ledger_account_transition = cls(
            id=id,
            uuid=uuid,
            action=action,
        ...
        api_ledger_account_transition.additional_properties = d
        return api_ledger_account_transition
