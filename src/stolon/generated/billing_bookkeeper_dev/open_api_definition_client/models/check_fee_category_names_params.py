...
T = TypeVar("T", bound="CheckFeeCategoryNamesParams")


@_attrs_define
class CheckFeeCategoryNamesParams:
    """
    Attributes:
        ...
        categories_to_ignore (Union[Unset, list[str]]):
    ...
    categories_to_ignore: Union[Unset, list[str]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        categories_to_ignore: Union[Unset, list[str]] = UNSET
        if not isinstance(self.categories_to_ignore, Unset):
            categories_to_ignore = self.categories_to_ignore
        ...
        if categories_to_ignore is not UNSET:
            field_dict["categoriesToIgnore"] = categories_to_ignore
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        categories_to_ignore = cast(list[str], d.pop("categoriesToIgnore", UNSET))
        ...
        check_fee_category_names_params = cls(
        ...
        check_fee_category_names_params.additional_properties = d
        return check_fee_category_names_params
