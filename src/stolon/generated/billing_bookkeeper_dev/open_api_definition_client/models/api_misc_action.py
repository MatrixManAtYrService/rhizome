...
T = TypeVar("T", bound="ApiMiscAction")
...
class ApiMiscAction:
    """
    Attributes:
        id (Union[Unset, int]): Id of the miscellaneous action
        uuid (Union[Unset, str]): 26-character UUID of the miscellaneous action
        billing_entity_uuid (Union[Unset, str]): 26-character UUID of the billing entity this miscellaneous action
            belongs to
        ...
        action_date_time (Union[Unset, datetime.datetime]): date and time that the miscellaneous action occurred
            Example: 2020-12-31T23:59:59.123456Z.
        num_units (Union[Unset, int]): the number of billable units for the miscellaneous action
        units_in_period (Union[Unset, int]): the number of billable units in the billing entity billing period
        basis_amount (Union[Unset, float]): the basis amount for the miscellaneous action
        basis_currency (Union[Unset, str]): 3-letter currency code Example: USD.
        reference (Union[Unset, str]): freeform comment or reference identifier for this miscellaneous action
        misc_action_fee_code_uuid (Union[Unset, str]): 26-character UUID of the misc-action-to-fee-code mapping used to
            create this action
        fee_uuid (Union[Unset, str]): 26-character UUID of the fee CTD or fee summary that this miscellaneous action was
            applied towards
        event_uuid (Union[Unset, str]): 26-character UUID of the billing event that triggered this miscellaneous action
        request_uuid (Union[Unset, str]): 26-character UUID of the billing request that posted this miscellaneous action
            to the current-to-date totals
        posting_date (Union[Unset, datetime.date]): posting date
        created_timestamp (Union[Unset, datetime.datetime]): date and time when the miscellaneous action was created
            Example: 2020-12-31T23:59:59.123456Z.
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the miscellaneous action was last
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_misc_action.additional_properties = d
        return api_misc_action
