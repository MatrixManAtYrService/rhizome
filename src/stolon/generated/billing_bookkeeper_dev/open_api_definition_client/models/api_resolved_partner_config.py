...
T = TypeVar("T", bound="ApiResolvedPartnerConfig")


@_attrs_define
class ApiResolvedPartnerConfig:
    """
    Attributes:
    ...
    tlement_method_be_uuid: Union[Unset, "ApiResolvedPartnerConfig"] = UNSET
    tlement_method: Union[Unset, "ApiResolvedPartnerConfig"] = UNSET
    partner_config: Union[Unset, "ApiPartnerConfig"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        partner_config: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.partner_config, Unset):
            partner_config = self.partner_config.to_dict()
        ...
        if partner_config is not UNSET:
            field_dict["partnerConfig"] = partner_config
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_resolved_partner_config = cls(
        ...
        api_resolved_partner_config.additional_properties = d
        return api_resolved_partner_config
