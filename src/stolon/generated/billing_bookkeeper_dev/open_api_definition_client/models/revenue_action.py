...
T = TypeVar("T", bound="RevenueAction")
...
class RevenueAction:
    ...
    Attributes:
        ...
        revenue_action_fee_code_uuid (Union[Unset, str]):
        source_billing_entity_uuid (Union[Unset, str]):
        source_billing_entity_name (Union[Unset, str]):
        source_entity_uuid (Union[Unset, str]):
        settlement_action_uuid (Union[Unset, str]):
    ...
    source_billing_entity_name: Union[Unset, str] = UNSET
    source_entity_uuid: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        source_billing_entity_name = self.source_billing_entity_name
        ...
        if source_billing_entity_name is not UNSET:
            field_dict["sourceBillingEntityName"] = source_billing_entity_name
        if source_entity_uuid is not UNSET:
            field_dict["sourceEntityUuid"] = source_entity_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        date_to_post: Union[Unset, datetime.date]
        if isinstance(_date_to_post, Unset):
            date_to_post = UNSET
        else:
        ...
        source_billing_entity_name = d.pop("sourceBillingEntityName", UNSET)

        source_entity_uuid = d.pop("sourceEntityUuid", UNSET)
        ...
        revenue_action = cls(
            ...
            source_billing_entity_name=source_billing_entity_name,
            source_entity_uuid=source_entity_uuid,
            settlement_action_uuid=settlement_action_uuid,
            action_type=action_type,
        )

        revenue_action.additional_properties = d
