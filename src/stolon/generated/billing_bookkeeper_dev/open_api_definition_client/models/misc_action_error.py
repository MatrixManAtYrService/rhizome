...
T = TypeVar("T", bound="MiscActionError")


@_attrs_define
class MiscActionError:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        misc_action_uuid (Union[Unset, str]):
    ...
    misc_action_uuid: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        misc_action_uuid = self.misc_action_uuid
        ...
        if misc_action_uuid is not UNSET:
            field_dict["miscActionUuid"] = misc_action_uuid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        misc_action_uuid = d.pop("miscActionUuid", UNSET)

        action_uuid = d.pop("actionUuid", UNSET)

        misc_action_error = cls(
            id=id,
            uuid=uuid,
            ...
            misc_action_uuid=misc_action_uuid,
            action_uuid=action_uuid,
        )

        misc_action_error.additional_properties = d
        return misc_action_error
