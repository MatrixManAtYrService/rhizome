...
T = TypeVar("T", bound="ApiAppMeterModifier")


@_attrs_define
class ApiAppMeterModifier:
    """app metered event modifiers

    Attributes:
        mod_type (Union[Unset, str]): type of app metered modifier
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_app_meter_modifier.additional_properties = d
        return api_app_meter_modifier
