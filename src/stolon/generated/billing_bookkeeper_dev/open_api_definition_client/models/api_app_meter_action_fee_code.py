...
T = TypeVar("T", bound="ApiAppMeterActionFeeCode")


@_attrs_define
class ApiAppMeterActionFeeCode:
    """
    Attributes:
        id (Union[Unset, int]): Id of the app-meter-action-to-fee-code mapping
        uuid (Union[Unset, str]): 26-character UUID of the app-meter-action-to-fee-code mapping
        developer_app_uuid (Union[Unset, str]): 13-character UUID of the developer app that the app-meter-action-to-fee-
            code mapping applies to
        app_metered_uuid (Union[Unset, str]): 13-character UUID of the app metered activity that the app-meter-action-
            to-fee-code mapping applies to
        merchant_plan_uuid (Union[Unset, str]): 13-character UUID of the merchant plan that the app-meter-action-to-fee-
            code mapping applies to
        app_meter_action_type (Union[Unset, str]): defined app meter action type value
        effective_date (Union[Unset, datetime.date]): effective date for the app-meter-action-to-fee-code mapping
        fee_category (Union[Unset, str]): fee category mapped to by the app meter action
        fee_code (Union[Unset, str]): fee code mapped to by the app meter action
        deleted_date (Union[Unset, datetime.date]): date the app-meter-action-to-fee-code mapping is no longer
            effective, or was logically deleted
        created_timestamp (Union[Unset, datetime.datetime]): date and time when the app-meter-action-to-fee-code mapping
            was created Example: 2020-12-31T23:59:59.123456Z.
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the app-meter-action-to-fee-code
            mapping was last modified Example: 2020-12-31T23:59:59.123456Z.
        audit_id (Union[Unset, str]): identifier for the user who created or last modified this app-meter-action-to-fee-
            code mapping
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_app_meter_action_fee_code = cls(
            id=id,
            uuid=uuid,
        ...
        api_app_meter_action_fee_code.additional_properties = d
        return api_app_meter_action_fee_code
