...
T = TypeVar("T", bound="ApiSimModifier")


@_attrs_define
class ApiSimModifier:
    """SIM modifiers

    Attributes:
        mod_type (Union[Unset, str]): type of SIM modifier
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_sim_modifier.additional_properties = d
        return api_sim_modifier
