...
T = TypeVar("T", bound="ApiCellularAction")


@_attrs_define
class ApiCellularAction:
    """
    Attributes:
        id (Union[Unset, int]): Id of the cellular action
        uuid (Union[Unset, str]): 26-character UUID of the cellular action
        billing_entity_uuid (Union[Unset, str]): 26-character UUID of the billing entity this cellular action belongs to
        ...
        iccid (Union[Unset, str]): the integrated circuit card identifier (ICCID) for the SIM that the cellular action
            applies to
        carrier (Union[Unset, str]): cellular carrier associated with the SIM
        ...
        action_date_time (Union[Unset, datetime.datetime]): date and time that the cellular action occurred Example:
            2020-12-31T23:59:59.123456Z.
        num_units (Union[Unset, int]): the number of billable units for the cellular action
        units_in_period (Union[Unset, int]): the number of billable units in the billing entity billing period
        basis_amount (Union[Unset, float]): the basis amount for the cellular action
        basis_currency (Union[Unset, str]): 3-letter currency code Example: USD.
        reference (Union[Unset, str]): freeform comment or reference identifier for this cellular action
        cellular_action_fee_code_uuid (Union[Unset, str]): 26-character UUID of the cellular-action-to-fee-code mapping
            used to create this action
        fee_uuid (Union[Unset, str]): 26-character UUID of the fee CTD or fee summary that this cellular action was
            applied towards
        event_uuid (Union[Unset, str]): 26-character UUID of the billing event that triggered this cellular action
        request_uuid (Union[Unset, str]): 26-character UUID of the billing request that posted this cellular action to
            the current-to-date totals
        posting_date (Union[Unset, datetime.date]): posting date
        created_timestamp (Union[Unset, datetime.datetime]): date and time when the cellular action was created Example:
            2020-12-31T23:59:59.123456Z.
        modified_timestamp (Union[Unset, datetime.datetime]): date and time when the cellular action was last modified
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_cellular_action.additional_properties = d
        return api_cellular_action
