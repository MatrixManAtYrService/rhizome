...
T = TypeVar("T", bound="ApiPlanActionFeeRateSummary")


@_attrs_define
class ApiPlanActionFeeRateSummary:
    """Summary list

    Attributes:
        merchant_plan_uuid (Union[Unset, str]): 13-character UUID of the merchant plan that the fee rate summary applies
            to
        device_type (Union[Unset, str]): type of device that this plan fee rate summary applies to
        plan_action_type (Union[Unset, str]): defined plan action type value
        fee_category (Union[Unset, str]): fee category value that plan fee rate summary is for
        fee_code (Union[Unset, str]): fee code value that plan fee rate summary is for
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_plan_action_fee_rate_summary = cls(
        ...
        api_plan_action_fee_rate_summary.additional_properties = d
        return api_plan_action_fee_rate_summary
