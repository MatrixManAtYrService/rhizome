...
def _get_kwargs() -> dict[str, Any]:
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/partnerconfig/invoicemethods",
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 400:
        ...
        for response_400_item_data in _response_400:
            response_400_item = ApiInvoiceMethod.from_dict(response_400_item_data)
    ...
    if response.status_code == 404:
        ...
        for response_404_item_data in _response_404:
            response_404_item = ApiInvoiceMethod.from_dict(response_404_item_data)
