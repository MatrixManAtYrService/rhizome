...
from ...models.api_plan_pricing_abstraction_updates import ApiPlanPricingAbstractionUpdates
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/v1/abstraction/planpricing/preview",
    }
...
) -> Optional[ApiPlanPricingAbstractionUpdates]:
    if response.status_code == 200:
        response_200 = ApiPlanPricingAbstractionUpdates.from_dict(response.json())
