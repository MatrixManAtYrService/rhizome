...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = ApiLedgerAccountTransition.from_dict(response.json())

        return response_400

    if response.status_code == 404:
        response_404 = ApiLedgerAccountTransition.from_dict(response.json())
