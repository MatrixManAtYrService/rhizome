...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[ApiBillingEntityConfig, ResponseError]]:
    ...
    if response.status_code == 400:
        response_400 = ApiBillingEntityConfig.from_dict(response.json())

        return response_400

    if response.status_code == 404:
        response_404 = ApiBillingEntityConfig.from_dict(response.json())
