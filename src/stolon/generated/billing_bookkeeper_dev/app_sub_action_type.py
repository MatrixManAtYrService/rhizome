...
def create_app_sub_action_type_sync_detailed(
    *, client: StolonClient, body: ApiAppSubActionType
    ...
    response = client.invoke_openapi(
        ...
        function_path="app_sub_action_type.create_app_sub_action_type",
...
def get_app_sub_action_types_by_action_type_sync_detailed(
    *, client: StolonClient, type_: Union[Unset, str] = UNSET
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="app_sub_action_type.get_app_sub_action_types_by_action_type",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
...
def get_app_sub_action_type_by_uuid_sync_detailed(*, client: StolonClient, uuid: str) -> Response[ResponseError]:
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="app_sub_action_type.get_app_sub_action_type_by_uuid",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
...
def delete_app_sub_action_type_by_uuid_sync_detailed(*, client: StolonClient, uuid: str) -> Response[ResponseError]:
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="app_sub_action_type.delete_app_sub_action_type_by_uuid",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
