...
from stolon.openapi_generated.billing_bookkeeper_dev.open_api_definition_client.models.api_app_sub_action_fee_code import (
...
def update_app_sub_action_fee_code_sync_detailed(
    *, client: StolonClient, uuid: str, body: ApiAppSubActionFeeCode
    ...
    response = client.invoke_openapi(
        ...
        function_path="app_sub_action_fee_code.update_app_sub_action_fee_code",
...
def delete_app_sub_action_fee_code_by_uuid_sync_detailed(*, client: StolonClient, uuid: str) -> Response[ResponseError]:
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="app_sub_action_fee_code.delete_app_sub_action_fee_code_by_uuid",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
...
def create_app_sub_action_fee_code_sync_detailed(
    *, client: StolonClient, body: ApiAppSubActionFeeCode
) -> Response[ResponseError]:
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="app_sub_action_fee_code.create_app_sub_action_fee_code",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
...
def create_app_sub_action_fee_code_sync(*, client: StolonClient, body: ApiAppSubActionFeeCode) -> ResponseError | None:
    """Create app subscription action fee code mapping
...
def get_app_sub_action_fee_code_by_uuid_sync_detailed(*, client: StolonClient, uuid: str) -> Response[ResponseError]:
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="app_sub_action_fee_code.get_app_sub_action_fee_code_by_uuid",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
...
def get_app_sub_action_fee_codes_sync_detailed(
    *,
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="app_sub_action_fee_code.get_app_sub_action_fee_codes",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
