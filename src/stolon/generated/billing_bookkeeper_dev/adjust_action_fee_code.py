...
from stolon.openapi_generated.billing_bookkeeper_dev.open_api_definition_client.models.api_adjust_action_fee_code import ApiAdjustActionFeeCode
...
def get_adjust_action_fee_codes_sync_detailed(
    *,
    ...
    kwargs = get_adjust_action_fee_codes._get_kwargs(date=date, adjust_reason=adjust_reason, developer_uuid=developer_uuid, developer_app_uuid=developer_app_uuid, fee_category=fee_category, fee_code=fee_code, adjust_action_type=adjust_action_type, page_size=page_size, page_number=page_number)
