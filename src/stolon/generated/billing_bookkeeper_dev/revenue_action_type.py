...
def delete_revenue_action_type_by_uuid_sync_detailed(*, client: StolonClient, uuid: str) -> Response[ResponseError]:
    ...
    response = client.invoke_openapi(
        ...
        function_path="revenue_action_type.delete_revenue_action_type_by_uuid",
...
def get_revenue_action_type_by_uuid_sync_detailed(*, client: StolonClient, uuid: str) -> Response[ResponseError]:
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="revenue_action_type.get_revenue_action_type_by_uuid",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
...
def create_revenue_action_type_sync_detailed(
    *, client: StolonClient, body: ApiRevenueActionType
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="revenue_action_type.create_revenue_action_type",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
...
def get_revenue_action_types_by_action_type_sync_detailed(
    *, client: StolonClient, type_: Union[Unset, str] = UNSET
    ...
    response = client.invoke_openapi(
        service=OpenAPIService.BILLING_BOOKKEEPER_DEV,
        function_path="revenue_action_type.get_revenue_action_types_by_action_type",
        variant="sync_detailed",
        domain="dev1.dev.clover.com",
        environment_name="dev",
        kwargs=serialized_kwargs,
