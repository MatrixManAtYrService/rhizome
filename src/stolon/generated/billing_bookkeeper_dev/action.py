...
from stolon.openapi_generated.billing_bookkeeper_dev.open_api_definition_client.api.action import get_action_by_reseller
from stolon.openapi_generated.billing_bookkeeper_dev.open_api_definition_client.api.action import get_actions
...
def get_action_by_reseller_sync_detailed(
    *,
    ...
    # Extract request parameters from generated function
    kwargs = get_action_by_reseller._get_kwargs(r_id=r_id, fee_uuid=fee_uuid, page_size=page_size, page_number=page_number, x_clover_appenv=x_clover_appenv)
