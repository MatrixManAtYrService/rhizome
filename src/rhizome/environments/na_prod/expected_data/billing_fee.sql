CREATE TABLE `fee` (
  ...
  `status` enum('PENDING','PENDING_EXCEPT','IN_PROGRESS','BILLED','CANCELED','EXCEPTED','WAIVED','FAILED_TO_BILL','EXPORTED') NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=353211760 DEFAULT CHARSET=utf8mb3