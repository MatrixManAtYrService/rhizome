"""
Expected data for merchant table in na_prod environment.
"""
...
class MerchantNaProd(Emplacement[Merchant]):
    """Expected data for Merchant in na_prod environment."""

    @classmethod
    def get_expected(cls) -> Merchant:
        """Get expected merchant data for na_prod environment."""
