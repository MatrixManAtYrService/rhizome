CREATE TABLE `account` (
  ...
  KEY `name` (`name`),
  KEY `password_email_name_primary_locked_idx` (`password_updated_time`,`email`,`name`,`primary_merchant_role_id`,`locked_out`),
...
) ENGINE=InnoDB AUTO_INCREMENT=35231126 DEFAULT CHARSET=utf8mb3