CREATE TABLE `invoice_charge` (
  ...
  `biie` enum('infoleaseEu','goleoEuJustBe','infoleaseUs','infoleaseUsCa','fileUsCaDMV','telecashEu','odessaUs','odessaEu','odessaUsCa') DEFAULT NULL,
  ...
  KEY `ic_charge_idx` (`charge_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3554841422 DEFAULT CHARSET=utf8mb3