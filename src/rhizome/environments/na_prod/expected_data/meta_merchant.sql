CREATE TABLE `merchant` (
  ...
  `customer_service_email` varchar(127) DEFAULT NULL,
  ...
  KEY `merchant_created_time_idx` (`created_time`),
  ...
  CONSTRAINT `merchant_ibfk_7` FOREIGN KEY (`locale_id`) REFERENCES `locale` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=5479900 DEFAULT CHARSET=utf8mb3