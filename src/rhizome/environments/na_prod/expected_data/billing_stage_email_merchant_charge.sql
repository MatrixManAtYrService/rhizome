CREATE TABLE `stage_email_merchant_charge` (
  ...
  `type` enum('CHARGES','ACH_REJECT','DEV_DISBMT','ACH_NO_AUTH','ACH_NSF','CREDIT_NOTE','DEV_ACH_REJECT') DEFAULT 'CHARGES',
...
) ENGINE=InnoDB AUTO_INCREMENT=30431178 DEFAULT CHARSET=utf8mb3