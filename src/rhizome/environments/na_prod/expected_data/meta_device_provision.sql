CREATE TABLE `device_provision` (
  ...
  `activation_code` char(8) CHARACTER SET latin1 NOT NULL,
  `activation_code_created_time` timestamp NULL DEFAULT NULL,
  `deauthorization_code` varchar(8) CHARACTER SET latin1 DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=7200236 DEFAULT CHARSET=utf8mb3