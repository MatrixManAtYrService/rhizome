"""
Development Billing environment configuration.

This module provides access to the development billing database
...
class DevBilling(Environment):
    """Development billing environment using direct database connection."""
