"""
Expected data for merchant_plan_group table in dev environment.
"""
...
class MerchantPlanGroupDev(Emplacement[MerchantPlanGroupV1]):
    """Expected data for MerchantPlanGroupV1 in dev environment."""
