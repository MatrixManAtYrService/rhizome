"""
Expected data for processor_key table in dev environment.
"""
...
class ProcessorKeyDev(Emplacement[ProcessorKeyV1]):
    """Expected data for ProcessorKeyV1 in dev environment."""
