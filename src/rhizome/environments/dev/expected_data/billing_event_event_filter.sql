CREATE TABLE `event_filter` (
  ...
  `criteria` enum('RESELLER','MERCHANT','DEVELOPER_APP','APP','OFFBOARDING_RESELLER','ABBS','ABBS_COLLECTION') NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2934 DEFAULT CHARSET=utf8mb3