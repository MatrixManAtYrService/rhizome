"""Expected data for fee_tax_mutation table in dev environment."""
...
class FeeTaxMutationDev(Emplacement[FeeTaxMutationV1]):
    """Expected data for FeeTaxMutation in dev environment."""
