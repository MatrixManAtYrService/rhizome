"""Expected data for processing_note_mutation table in dev environment."""
...
class ProcessingNoteMutationDev(Emplacement[ProcessingNoteMutationV1]):
    """Expected data for ProcessingNoteMutation in dev environment."""
