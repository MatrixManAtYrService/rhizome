"""Expected data for tiered_qualifier table in dev environment."""
...
class TieredQualifierDev(Emplacement[TieredQualifierV1]):
    """Expected data for TieredQualifier in dev environment."""
