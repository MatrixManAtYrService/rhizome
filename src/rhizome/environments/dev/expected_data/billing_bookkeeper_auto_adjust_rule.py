"""Expected data for auto_adjust_rule table in dev environment."""
...
class AutoAdjustRuleDev(Emplacement[AutoAdjustRuleV1]):
    """Expected data for AutoAdjustRule in dev environment."""
