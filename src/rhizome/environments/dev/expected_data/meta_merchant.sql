CREATE TABLE `merchant` (
  ...
  `giftcards_enabled` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `infolease_suppress_plan_billing` tinyint(1) DEFAULT '0',
  ...
  CONSTRAINT `merchant_ibfk_3` FOREIGN KEY (`subscription_id`) REFERENCES `subscription` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `merchant_ibfk_4` FOREIGN KEY (`address_id`) REFERENCES `merchant_address` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `merchant_ibfk_5` FOREIGN KEY (`timezone_id`) REFERENCES `timezones` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `merchant_ibfk_6` FOREIGN KEY (`locale_id`) REFERENCES `locale` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=3940409 DEFAULT CHARSET=utf8mb3