"""Expected data for monetary_adjustment_mutation table in dev environment."""
...
class MonetaryAdjustmentMutationDev(Emplacement[MonetaryAdjustmentMutationV1]):
    """Expected data for MonetaryAdjustmentMutation in dev environment."""
