"""
Expected data for app_subscription table in dev environment.
"""
...
class AppSubscriptionDev(Emplacement[AppSubscriptionV1]):
    """Expected data for AppSubscriptionV1 in dev environment."""
