"""
Expected data for app_metered_country table in dev environment.
"""
...
class AppMeteredCountryDev(Emplacement[AppMeteredCountryV1]):
    """Expected data for AppMeteredCountryV1 in dev environment."""
