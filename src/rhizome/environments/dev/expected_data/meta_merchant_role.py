"""
Expected data for merchant_role table in dev environment.
"""
...
class MerchantRoleDev(Emplacement[MerchantRoleV1]):
    """Expected data for MerchantRoleV1 in dev environment."""
