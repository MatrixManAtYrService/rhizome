"""
Expected data for app_app_bundle table in dev environment.
"""
...
class AppAppBundleDev(Emplacement[AppAppBundleV1]):
    """Expected data for AppAppBundleV1 in dev environment."""
