"""Expected data for fee_rate_report_action_error table in dev environment."""
...
class FeeRateReportActionErrorDev(Emplacement[FeeRateReportActionErrorV1]):
    """Expected data for FeeRateReportActionError in dev environment."""
