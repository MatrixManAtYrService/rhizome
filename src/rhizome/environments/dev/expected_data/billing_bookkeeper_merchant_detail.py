"""Expected data for merchant_detail table in dev environment."""
...
class MerchantDetailDev(Emplacement[MerchantDetailV1]):
    """Expected data for MerchantDetail in dev environment."""
