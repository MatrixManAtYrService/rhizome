"""Expected data for cellular_action table in dev environment."""
...
class CellularActionDev(Emplacement[CellularActionV1]):
    """Expected data for CellularAction in dev environment."""
