"""
Expected data for merchant_boarding table in dev environment.
"""
...
class MerchantBoardingDev(Emplacement[MerchantBoardingV1]):
    """Expected data for MerchantBoardingV1 in dev environment."""
