"""Expected data for cellular_action_type table in dev environment."""
...
class CellularActionTypeDev(Emplacement[CellularActionTypeV1]):
    """Expected data for CellularActionType in dev environment."""
