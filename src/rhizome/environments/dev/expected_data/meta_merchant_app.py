"""
Expected data for merchant_app table in dev environment.
"""
...
class MerchantAppDev(Emplacement[MerchantAppV1]):
    """Expected data for MerchantAppV1 in dev environment."""
