"""Expected data for app_meter_action table in dev environment."""
...
class AppMeterActionDev(Emplacement[AppMeterActionV1]):
    """Expected data for AppMeterAction in dev environment."""
