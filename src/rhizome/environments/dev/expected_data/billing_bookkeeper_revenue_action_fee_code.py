"""Expected data for revenue_action_fee_code table in dev environment."""
...
class RevenueActionFeeCodeDev(Emplacement[RevenueActionFeeCodeV1]):
    """Expected data for RevenueActionFeeCode in dev environment."""
