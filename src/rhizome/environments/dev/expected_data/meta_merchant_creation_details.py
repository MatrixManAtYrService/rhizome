"""
Expected data for merchant_creation_details table in dev environment.
"""
...
class MerchantCreationDetailsDev(Emplacement[MerchantCreationDetailsV1]):
    """Expected data for MerchantCreationDetailsV1 in dev environment."""
