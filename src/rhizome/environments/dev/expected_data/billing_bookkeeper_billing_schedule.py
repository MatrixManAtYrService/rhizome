"""Expected data for billing_schedule table in dev environment."""
...
class BillingScheduleDev(Emplacement[BillingScheduleV1]):
    """Expected data for BillingSchedule in dev environment."""
