CREATE TABLE `merchant_app` (
  ...
  `permission_customers_address_read` tinyint(1) DEFAULT '0',
  `permission_customers_address_write` tinyint(1) DEFAULT '0',
  `permission_customers_email_read` tinyint(1) DEFAULT '0',
  `permission_customers_email_write` tinyint(1) DEFAULT '0',
  `permission_customers_phone_read` tinyint(1) DEFAULT '0',
  `permission_customers_phone_write` tinyint(1) DEFAULT '0',
  `permission_customers_businessname_read` tinyint(1) DEFAULT '0',
  `permission_customers_businessname_write` tinyint(1) DEFAULT '0',
  `permission_customers_birthdate_read` tinyint(1) DEFAULT '0',
  `permission_customers_birthdate_write` tinyint(1) DEFAULT '0',
  `permission_customers_note_read` tinyint(1) DEFAULT '0',
  `permission_customers_note_write` tinyint(1) DEFAULT '0',
  `permission_customers_card_read` tinyint(1) DEFAULT '0',
  `permission_customers_card_write` tinyint(1) DEFAULT '0',
  `permission_customers_ach_read` tinyint unsigned DEFAULT '0',
  `permission_customers_ach_write` tinyint unsigned DEFAULT '0',
  `permission_customers_marketing_read` tinyint(1) DEFAULT '0',
  `permission_customers_marketing_write` tinyint(1) DEFAULT '0',
