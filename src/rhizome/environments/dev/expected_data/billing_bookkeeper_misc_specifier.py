"""Expected data for misc_specifier table in dev environment."""
...
class MiscSpecifierDev(Emplacement[MiscSpecifierV1]):
    """Expected data for MiscSpecifier in dev environment."""
