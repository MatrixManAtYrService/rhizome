"""
Expected data for merchant_gateway table in dev environment.
"""
...
class MerchantGatewayDev(Emplacement[MerchantGatewayV1]):
    """Expected data for MerchantGatewayV1 in dev environment."""
