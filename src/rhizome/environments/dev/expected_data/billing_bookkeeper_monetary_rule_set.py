"""Expected data for monetary_rule_set table in dev environment."""
...
class MonetaryRuleSetDev(Emplacement[MonetaryRuleSetV1]):
    """Expected data for MonetaryRuleSet in dev environment."""
