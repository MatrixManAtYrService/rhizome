"""Expected data for billing_hierarchy_cycle table in dev environment."""
...
class BillingHierarchyCycleDev(Emplacement[BillingHierarchyCycleV1]):
    """Expected data for BillingHierarchyCycle in dev environment."""
