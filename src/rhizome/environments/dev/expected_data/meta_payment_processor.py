"""
Expected data for payment_processor table in dev environment.
"""
...
class PaymentProcessorDev(Emplacement[PaymentProcessorV1]):
    """Expected data for PaymentProcessorV1 in dev environment."""
