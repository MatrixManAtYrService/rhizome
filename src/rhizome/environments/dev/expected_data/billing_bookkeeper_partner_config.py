"""Expected data for partner_config table in dev environment."""
...
class PartnerConfigDev(Emplacement[PartnerConfigV1]):
    """Expected data for PartnerConfig in dev environment."""
