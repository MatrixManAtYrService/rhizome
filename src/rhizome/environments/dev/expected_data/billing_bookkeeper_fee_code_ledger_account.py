"""Expected data for fee_code_ledger_account table in dev environment."""
...
class FeeCodeLedgerAccountDev(Emplacement[FeeCodeLedgerAccountV1]):
    """Expected data for FeeCodeLedgerAccount in dev environment."""
