"""Expected data for monetary_rule_alias table in dev environment."""
...
class MonetaryRuleAliasDev(Emplacement[MonetaryRuleAliasV1]):
    """Expected data for MonetaryRuleAlias in dev environment."""
