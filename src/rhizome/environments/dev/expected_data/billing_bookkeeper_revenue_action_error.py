"""Expected data for revenue_action_error table in dev environment."""
...
class RevenueActionErrorDev(Emplacement[RevenueActionErrorV1]):
    """Expected data for RevenueActionError in dev environment."""
