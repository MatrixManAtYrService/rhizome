"""Expected data for adjust_action table in dev environment."""
...
class AdjustActionDev(Emplacement[AdjustActionV1]):
    """Expected data for AdjustAction in dev environment."""
