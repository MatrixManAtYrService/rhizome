"""
Expected data for app_subscription_country table in dev environment.
"""
...
class AppSubscriptionCountryDev(Emplacement[AppSubscriptionCountryV1]):
    """Expected data for AppSubscriptionCountryV1 in dev environment."""
