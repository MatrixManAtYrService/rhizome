"""
Expected data for developer_app table in dev environment.
"""
...
class DeveloperAppDev(Emplacement[DeveloperAppV1]):
    """Expected data for DeveloperAppV1 in dev environment."""
