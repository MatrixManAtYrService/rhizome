"""Expected data for ledger_account_action table in dev environment."""
...
class LedgerAccountActionDev(Emplacement[LedgerAccountActionV1]):
    """Expected data for LedgerAccountAction in dev environment."""
