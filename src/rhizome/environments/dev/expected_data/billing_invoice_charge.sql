CREATE TABLE `invoice_charge` (
  ...
  `biie` enum('infoleaseEu','goleoEuJustBe','infoleaseUs','infoleaseUsCa','fileUsCaDMV','telecashEu','odessaUs','odessaUsCa') DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=71451037 DEFAULT CHARSET=utf8mb3