"""
Expected data for server_feature table in dev environment.
"""
...
class ServerFeatureDev(Emplacement[ServerFeatureV1]):
    """Expected data for ServerFeatureV1 in dev environment."""
