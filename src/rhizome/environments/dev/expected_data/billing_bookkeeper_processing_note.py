"""Expected data for processing_note table in dev environment."""
...
class ProcessingNoteDev(Emplacement[ProcessingNoteV1]):
    """Expected data for ProcessingNote in dev environment."""
