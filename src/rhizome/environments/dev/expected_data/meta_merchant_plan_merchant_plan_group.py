"""
Expected data for merchant_plan_merchant_plan_group table in dev environment.
"""
...
class MerchantPlanMerchantPlanGroupDev(Emplacement[MerchantPlanMerchantPlanGroupV1]):
    """Expected data for MerchantPlanMerchantPlanGroupV1 in dev environment."""
