"""Expected data for monetary_adjustment table in dev environment."""
...
class MonetaryAdjustmentDev(Emplacement[MonetaryAdjustmentV1]):
    """Expected data for MonetaryAdjustment in dev environment."""
