"""Expected data for plan_action_fee_code table in demo environment."""
...
class PlanActionFeeCodeDemo(Emplacement[PlanActionFeeCodeV1]):
    """Expected data for PlanActionFeeCode in demo environment."""
