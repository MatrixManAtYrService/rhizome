"""
Expected data for app_subscription table in demo environment.
"""
...
class AppSubscriptionDemo(Emplacement[AppSubscriptionV1]):
    """Expected data for AppSubscription in demo environment."""
