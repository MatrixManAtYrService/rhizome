"""Expected data for ledger_account_balance table in demo environment."""
...
class LedgerAccountBalanceDemo(Emplacement[LedgerAccountBalanceV1]):
    """Expected data for LedgerAccountBalance in demo environment."""
