"""
Expected data for processor_key table in demo environment.
"""
...
class ProcessorKeyDemo(Emplacement[ProcessorKeyV1]):
    """Expected data for ProcessorKey in demo environment."""
