"""Expected data for ledger_account_key_app table in demo environment."""
...
class LedgerAccountKeyAppDemo(Emplacement[LedgerAccountKeyAppV1]):
    """Expected data for LedgerAccountKeyApp in demo environment."""
