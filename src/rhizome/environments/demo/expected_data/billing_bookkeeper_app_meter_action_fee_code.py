"""Expected data for app_meter_action_fee_code table in demo environment."""
...
class AppMeterActionFeeCodeDemo(Emplacement[AppMeterActionFeeCodeV1]):
    """Expected data for AppMeterActionFeeCode in demo environment."""
