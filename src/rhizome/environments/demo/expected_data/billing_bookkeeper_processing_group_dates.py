"""Expected data for processing_group_dates table in demo environment."""
...
class ProcessingGroupDatesDemo(Emplacement[ProcessingGroupDatesV1]):
    """Expected data for ProcessingGroupDates in demo environment."""
