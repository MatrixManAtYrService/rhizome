"""
Expected data for fee_summary table in demo environment.
"""
...
class FeeSummaryDemo(Emplacement[FeeSummaryV1]):
    """Expected data for FeeSummary in demo environment."""

    @classmethod
    def get_expected(cls) -> FeeSummaryV1:
        """Get expected fee summary data for demo environment."""
