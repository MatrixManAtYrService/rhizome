"""Expected data for model_fee_summary table in demo environment."""
...
class ModelFeeSummaryDemo(Emplacement[ModelFeeSummaryV1]):
    """Expected data for ModelFeeSummary in demo environment."""
