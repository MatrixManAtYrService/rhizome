"""
Expected data for app_app_bundle table in demo environment.
"""
...
class AppAppBundleDemo(Emplacement[AppAppBundleV1]):
    """Expected data for AppAppBundle in demo environment."""
