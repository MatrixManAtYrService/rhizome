"""Expected data for app_meter_action_error table in demo environment."""
...
class AppMeterActionErrorDemo(Emplacement[AppMeterActionErrorV1]):
    """Expected data for AppMeterActionError in demo environment."""
