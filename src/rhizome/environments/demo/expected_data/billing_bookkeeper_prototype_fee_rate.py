"""Expected data for prototype_fee_rate table in demo environment."""
...
class PrototypeFeeRateDemo(Emplacement[PrototypeFeeRateV1]):
    """Expected data for PrototypeFeeRate in demo environment."""
