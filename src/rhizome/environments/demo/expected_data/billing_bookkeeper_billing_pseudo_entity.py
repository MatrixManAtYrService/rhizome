"""Expected data for billing_pseudo_entity table in demo environment."""
...
class BillingPseudoEntityDemo(Emplacement[BillingPseudoEntityV1]):
    """Expected data for BillingPseudoEntity in demo environment."""
