"""
Expected data for merchant_creation_details table in demo environment.
"""
...
class MerchantCreationDetailsDemo(Emplacement[MerchantCreationDetailsV1]):
    """Expected data for MerchantCreationDetails in demo environment."""
