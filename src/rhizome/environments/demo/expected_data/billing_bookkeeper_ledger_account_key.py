"""Expected data for ledger_account_key table in demo environment."""
...
class LedgerAccountKeyDemo(Emplacement[LedgerAccountKeyV1]):
    """Expected data for LedgerAccountKey in demo environment."""
