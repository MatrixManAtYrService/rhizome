"""Expected data for cycle_validation_mutation table in demo environment."""
...
class CycleValidationMutationDemo(Emplacement[CycleValidationMutationV1]):
    """Expected data for CycleValidationMutation in demo environment."""
