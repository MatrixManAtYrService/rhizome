"""Expected data for revenue_action_type table in demo environment."""
...
class RevenueActionTypeDemo(Emplacement[RevenueActionTypeV1]):
    """Expected data for RevenueActionType in demo environment."""
