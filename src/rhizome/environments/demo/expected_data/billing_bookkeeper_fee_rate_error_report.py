"""Expected data for fee_rate_error_report table in demo environment."""
...
class FeeRateErrorReportDemo(Emplacement[FeeRateErrorReportV1]):
    """Expected data for FeeRateErrorReport in demo environment."""
