"""Expected data for billing_hierarchy_type table in demo environment."""
...
class BillingHierarchyTypeDemo(Emplacement[BillingHierarchyTypeV1]):
    """Expected data for BillingHierarchyType in demo environment."""
