"""Expected data for ledger_account_purpose table in demo environment."""
...
class LedgerAccountPurposeDemo(Emplacement[LedgerAccountPurposeV1]):
    """Expected data for LedgerAccountPurpose in demo environment."""
