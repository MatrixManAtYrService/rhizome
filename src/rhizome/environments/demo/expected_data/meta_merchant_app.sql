CREATE TABLE `merchant_app` (
  ...
  KEY `idx_ma_billing_start_time` (`billing_start_time`),
  CONSTRAINT `merchant_app_ibfk_1` FOREIGN KEY (`app_id`) REFERENCES `developer_app` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `merchant_app_ibfk_2` FOREIGN KEY (`merchant_id`) REFERENCES `merchant` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `merchant_app_ibfk_3` FOREIGN KEY (`app_subscription_id`) REFERENCES `app_subscription` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=2018409 DEFAULT CHARSET=utf8mb3