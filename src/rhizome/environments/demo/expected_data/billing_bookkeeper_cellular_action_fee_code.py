"""Expected data for cellular_action_fee_code table in demo environment."""
...
class CellularActionFeeCodeDemo(Emplacement[CellularActionFeeCodeV1]):
    """Expected data for CellularActionFeeCode in demo environment."""
