"""
Expected data for merchant_gateway table in demo environment.
"""
...
class MerchantGatewayDemo(Emplacement[MerchantGatewayV1]):
    """Expected data for MerchantGateway in demo environment."""
