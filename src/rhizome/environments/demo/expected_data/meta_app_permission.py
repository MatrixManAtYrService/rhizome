"""
Expected data for app_permission table in demo environment.
"""
...
class AppPermissionDemo(Emplacement[AppPermissionV1]):
    """Expected data for AppPermission in demo environment."""
