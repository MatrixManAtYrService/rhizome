"""Expected data for settlement_action table in demo environment."""
...
class SettlementActionDemo(Emplacement[SettlementActionV1]):
    """Expected data for SettlementAction in demo environment."""
