CREATE TABLE `app_metered_event` (
  ...
  `app_line_item_id` bigint unsigned DEFAULT NULL,
  ...
  KEY `app_line_item_id` (`app_line_item_id`),
  ...
  CONSTRAINT `app_metered_event_ibfk_3` FOREIGN KEY (`app_line_item_id`) REFERENCES `charge` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
