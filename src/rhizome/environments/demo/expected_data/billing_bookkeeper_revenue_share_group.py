"""Expected data for revenue_share_group table in demo environment."""
...
class RevenueShareGroupDemo(Emplacement[RevenueShareGroupV1]):
    """Expected data for RevenueShareGroup in demo environment."""
