"""
Expected data for device_events table in demo environment.
"""
...
class DeviceEventsDemo(Emplacement[DeviceEventsV1]):
    """Expected data for DeviceEvents in demo environment."""
