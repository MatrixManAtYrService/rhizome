"""
Expected data for terminal_config_merchant_props table in demo environment.
"""
...
class TerminalConfigMerchantPropsDemo(Emplacement[TerminalConfigMerchantPropsV1]):
    """Expected data for TerminalConfigMerchantProps in demo environment."""
