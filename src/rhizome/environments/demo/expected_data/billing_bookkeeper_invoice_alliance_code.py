"""Expected data for invoice_alliance_code table in demo environment."""
...
class InvoiceAllianceCodeDemo(Emplacement[InvoiceAllianceCodeV1]):
    """Expected data for InvoiceAllianceCode in demo environment."""
