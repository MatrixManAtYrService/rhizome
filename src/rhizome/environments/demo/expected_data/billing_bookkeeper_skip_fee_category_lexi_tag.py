"""Expected data for skip_fee_category_lexi_tag table in demo environment."""
...
class SkipFeeCategoryLexiTagDemo(Emplacement[SkipFeeCategoryLexiTagV1]):
    """Expected data for SkipFeeCategoryLexiTag in demo environment."""
