"""
Expected data for device_provision table in demo environment.
"""
...
class DeviceProvisionDemo(Emplacement[DeviceProvisionV1]):
    """Expected data for DeviceProvision in demo environment."""
