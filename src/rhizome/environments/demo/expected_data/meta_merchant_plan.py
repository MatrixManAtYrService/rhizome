"""
Expected data for merchant_plan table in demo environment.
"""
...
class MerchantPlanDemo(Emplacement[MerchantPlanV1]):
    """Expected data for MerchantPlan in demo environment."""
