"""Expected data for auto_adjust_qualifier table in demo environment."""
...
class AutoAdjustQualifierDemo(Emplacement[AutoAdjustQualifierV1]):
    """Expected data for AutoAdjustQualifier in demo environment."""
