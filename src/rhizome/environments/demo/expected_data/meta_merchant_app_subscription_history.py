"""
Expected data for merchant_app_subscription_history table in demo environment.
"""
...
class MerchantAppSubscriptionHistoryDemo(Emplacement[MerchantAppSubscriptionHistoryV1]):
    """Expected data for MerchantAppSubscriptionHistory in demo environment."""
