"""
Expected data for merchant_plan_group table in demo environment.
"""
...
class MerchantPlanGroupDemo(Emplacement[MerchantPlanGroupV1]):
    """Expected data for MerchantPlanGroup in demo environment."""
