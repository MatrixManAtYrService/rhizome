"""Expected data for misc_action_fee_code table in demo environment."""
...
class MiscActionFeeCodeDemo(Emplacement[MiscActionFeeCodeV1]):
    """Expected data for MiscActionFeeCode in demo environment."""
