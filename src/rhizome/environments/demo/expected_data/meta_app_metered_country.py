"""
Expected data for app_metered_country table in demo environment.
"""
...
class AppMeteredCountryDemo(Emplacement[AppMeteredCountryV1]):
    """Expected data for AppMeteredCountry in demo environment."""
