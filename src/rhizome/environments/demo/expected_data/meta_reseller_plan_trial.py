"""
Expected data for reseller_plan_trial table in demo environment.
"""
...
class ResellerPlanTrialDemo(Emplacement[ResellerPlanTrialV1]):
    """Expected data for ResellerPlanTrial in demo environment."""
