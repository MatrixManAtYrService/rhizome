"""Expected data for adjust_reason table in demo environment."""
...
class AdjustReasonDemo(Emplacement[AdjustReasonV1]):
    """Expected data for AdjustReason in demo environment."""
