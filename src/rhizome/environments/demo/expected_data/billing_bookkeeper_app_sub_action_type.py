"""Expected data for app_sub_action_type table in demo environment."""
...
class AppSubActionTypeDemo(Emplacement[AppSubActionTypeV1]):
    """Expected data for AppSubActionType in demo environment."""
