"""Expected data for ledger_account table in demo environment."""
...
class LedgerAccountDemo(Emplacement[LedgerAccountV1]):
    """Expected data for LedgerAccount in demo environment."""
