...
class DemoBookkeeper(DatabaseEnvironment):
    ...
    def get_sql_connection(self) -> str:
        ...
        return "clover-demo-databases:us-central1:billing-bookkeeper"

    def get_database_name(self) -> str:
        """Get database name."""
        return "billing-bookkeeper-demo"
