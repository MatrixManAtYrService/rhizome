"""
SQLModel definition for the app_meter_action table.

This module provides the SQLModel class for the app_meter_action table from the
...
class AppMeterAction(RhizomeModel, table=False):
    """
    SQLModel for the `app_meter_action` table.

    This model represents app meter action records in the billing system.
    """
    ...
    def sanitize(self) -> AppMeterAction:
        """Return a sanitized copy of this AppMeterAction instance."""
        return AppMeterAction(
            id=self.id,
            ...
            app_meter_action_fee_code_uuid=sanitize_uuid_field(self.app_meter_action_fee_code_uuid, 26),
