"""
SQLModel definition for the app_sub_action_fee_code table.

This module provides the SQLModel class for the app_sub_action_fee_code table from the
...
class AppSubActionFeeCode(RhizomeModel, table=False):
    """
    SQLModel for the `app_sub_action_fee_code` table.

    This model represents app sub action fee code records in the billing system.
    """
    ...
    def sanitize(self) -> AppSubActionFeeCode:
        """Return a sanitized copy of this AppSubActionFeeCode instance."""
        return AppSubActionFeeCode(
            id=self.id,
