"""
SQLModel definition for the cellular_action table.

This module provides the SQLModel class for the cellular_action table from the
...
class CellularAction(RhizomeModel, table=False):
    """
    SQLModel for the `cellular_action` table.

    This model represents cellular action records in the billing system.
    """
    ...
    iccid: str = Field(max_length=24, description="Iccid")
    carrier: str = Field(max_length=25, description="Carrier")
    ...
    cellular_action_fee_code_uuid: str | None = Field(default=None, max_length=26, description="Cellular Action Fee Code Uuid")
    ...
    def sanitize(self) -> CellularAction:
        """Return a sanitized copy of this CellularAction instance."""
        return CellularAction(
            id=self.id,
            ...
            cellular_action_fee_code_uuid=sanitize_uuid_field(self.cellular_action_fee_code_uuid, 26),
