"""
SQLModel definition for the billing_entity_config table.

This module provides the SQLModel class for the billing_entity_config table from the
...
class BillingEntityConfig(RhizomeModel, table=False):
    """
    SQLModel for the `billing_entity_config` table.

    This model represents billing entity config records in the billing system.
    """
    ...
    def sanitize(self) -> BillingEntityConfig:
        """Return a sanitized copy of this BillingEntityConfig instance."""
        return BillingEntityConfig(
            id=self.id,
