"""
SQLModel definition for the monetary_adjustment table.

This module provides the SQLModel class for the monetary_adjustment table from the
...
class MonetaryAdjustment(RhizomeModel, table=False):
    """
    SQLModel for the `monetary_adjustment` table.

    This model represents monetary adjustment records in the billing system.
    """
    ...
    def sanitize(self) -> MonetaryAdjustment:
        """Return a sanitized copy of this MonetaryAdjustment instance."""
