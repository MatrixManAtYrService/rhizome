"""
SQLModel definition for the stage_vendor_disbursement_state_attempt table.

This module provides the SQLModel class for the stage_vendor_disbursement_state_attempt table from the
...
class StageVendorDisbursementStateAttempt(RhizomeModel, table=False):
    """
    SQLModel for the `stage_vendor_disbursement_state_attempt` table.

    This model represents stage_vendor_disbursement_state_attempt records in the billing system.
    """
    ...
    def sanitize(self) -> StageVendorDisbursementStateAttempt:
        """Return a sanitized copy of this StageVendorDisbursementStateAttempt instance."""
        return StageVendorDisbursementStateAttempt(
            id=self.id,
